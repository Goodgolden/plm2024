...
```{r "baseline"}
base_outcome<- read.csv("newdata/tsa_clean_baseline_for_outcome_2023-11-07.csv", row.names = 1)
outcome <- read.csv("newdata/tsa_clean_baseout_2023-11-07.csv", row.names = 1)
