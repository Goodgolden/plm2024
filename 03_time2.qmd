...
```{r "baseline"}
baseline0 <- read.csv("newdata/tsa_clean_baseline_for_outcome_2023-11-07.csv", row.names = 1)
baseout0 <- read.csv("newdata/tsa_clean_baseout_2023-11-07.csv", row.names = 1)
```
...
write.csv(baseline2, file = paste0("newdata/final_tsa_clean_baseline_for_insurance", Sys.Date(), ".csv"))
...
The newly updated baseline longitudinal dataset: `RTSA N = 981`; `TSA N = 1,515`
:::
