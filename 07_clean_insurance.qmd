...
baseline_insurance <- read_csv("newdata/final_tsa_clean_baseline_for_insurance2023-12-04.csv")
...
set.seed(555)
tsa00 <- read.csv("newdata/tsa_clean_baseout_2023-11-07.csv", 
                 row.names = 1) %>%
...
some people will lose their first surgery or their second surgery.
so the people with both surgery 
...
```{r "tsa_final_baseline", class.output="scroll-100"}
tsa_baseline
```
