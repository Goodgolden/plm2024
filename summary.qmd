...
2. how did we calculate the coverage and bias and all the things, the symmetric

3. $\kappa$ the cross-validation, $\alpha$ cross validation 

4. the quantile of the cutoff; this programming the $\alpha$ cut off
